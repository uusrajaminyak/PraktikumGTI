...
void Eksterior() {
    ...
    glBegin(GL_POLYGON);
    glVertex3f(-1.51f, 0.7f, 2.0f);   
    glVertex3f(-1.51f, 1.4f, 0.0f);   
    glVertex3f(-1.51f, 0.95f, -2.0f); 
    glVertex3f(-1.51f, 0.7f, -2.0f);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glVertex3f(-1.4f, 0.8f, 2.5f);
    glVertex3f(1.4f, 0.8f, 2.5f);
    glVertex3f(1.4f, 1.5f, 0.3f);
    glVertex3f(-1.4f, 1.5f, 0.3f);
    glEnd();

    glColor3f(1.0f, 0.9f, 0.5f); 
    glBegin(GL_QUADS);
    glVertex3f(-1.4f, 0.5f, 3.01f);
    glVertex3f(1.4f, 0.5f, 3.01f);
    glVertex3f(1.4f, 0.55f, 3.01f);
    glVertex3f(-1.4f, 0.55f, 3.01f);
    glEnd();
    
    glColor3f(1.0f, 0.0f, 0.0f); 
    glBegin(GL_QUADS);
    glVertex3f(-1.4f, 0.8f, -3.01f);
    glVertex3f(1.4f, 0.8f, -3.01f);
    glVertex3f(1.4f, 0.85f, -3.01f);
    glVertex3f(-1.4f, 0.85f, -3.01f);
    glEnd();
}
