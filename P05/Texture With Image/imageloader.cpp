...
namespace {
    ...
    // Template untuk manajemen array otomatis
    template<class T>
    class auto_array {
    private:
        T* array;
...
Image* loadBMP(const char* filename) {
    ...
    switch (headerSize) {
        ...
        case 12:
            ...
            assert(readShort(input) == 24 || !"Gambar tidak 24 bits per pixel!");
            break;
        case 64: assert(!"Tidak dapat mengambil OS/2 V2 bitmaps"); break;
        case 108: assert(!"Tidak dapat mengambil Windows V4 bitmaps"); break;
        case 124: assert(!"Tidak dapat mengambil Windows V5 bitmaps"); break;
        default: assert(!"Format bitmap ini tidak diketahui!");
    }
